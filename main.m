...
filename = 'E:\training data\sample.xlsx';
 
X1=xlsread(filename);
filename1 = 'E:\training data\training.xlsx';
 
X2=xlsread(filename1);


filename2 = 'E:\training data\group.xlsx';
X3=xlsread(filename2);
 
filename3 = 'E:\training data\Book.xlsx';
